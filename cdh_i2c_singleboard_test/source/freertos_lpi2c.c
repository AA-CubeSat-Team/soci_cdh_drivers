/*
 *
 * works out of box when all of these met
 * - IOMUXC_GPIO_AD_B1_00_LPI2C1_SCL is connected to IOMUXC_GPIO_AD_B1_07_LPI2C3_SCL
 * - IOMUXC_GPIO_AD_B1_01_LPI2C1_SDA is connected to IOMUXC_GPIO_AD_B1_06_LPI2C3_SDA
 * - EXAMPLE_CONNECT_I2C == SINGLE_BOARD
 *
 *
